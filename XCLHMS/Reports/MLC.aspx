<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MLC.aspx.cs" Inherits="XCLHMS.Reports.MLC" %>
...
<body>
    ...
    <div>
     <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="78%" Height="932px"></rsweb:ReportViewer>
    </div>
    </form>
</body>
</html>
