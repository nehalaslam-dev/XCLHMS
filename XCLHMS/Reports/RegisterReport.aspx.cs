...
namespace XCLHMS.Reports
{
    public partial class RegisterReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                //ObjectResult<Report_AccountRegister_Result> acc = db.Report_AccountRegister(Convert.ToInt32(searchText));
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/Register.rdlc");
